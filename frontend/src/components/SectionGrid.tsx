    ...
    <section
      className={
        embedded
          ...
          : 'panel-card flex h-full min-h-0 w-full flex-col overflow-hidden'
      }
    >
      {!embedded && (
        <div className="flex shrink-0 items-start justify-between gap-3 border-b border-line px-4 py-3">
          <div className="min-w-0">
            <h2 className="text-sm font-semibold text-ink">{vi.keypadSectionsTitle}</h2>
